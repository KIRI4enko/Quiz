...
class Team(models.Model):
    ...
    name = models.CharField(
        ...
        unique=True, 
        error_messages=
        {'unique': 'Команда с таким названием уже существует. Пожалуйста, выберите другое название.'}
    )
...
class QuestionImage(models.Model):
    """Изображения к вопросу (до 4 шт., порядок — по дате добавления)."""
    ...
    image = models.ImageField('Файл', upload_to='questions/gallery/')
